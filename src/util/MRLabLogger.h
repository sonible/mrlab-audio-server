 ...
 */
class MRLabLogger : public juce::FileLogger
{
public:
    //==============================================================================
    enum class LogLevel
    ...
    struct Listener
    {
        ...
        virtual void onWriteToLog (const juce::String& message) = 0;
    };

    //==============================================================================
    MRLabLogger() : juce::FileLogger (APP_SUPPORT_DIR.getChildFile ("MRLabLog.txt"), "\n\n==== MRLabLog Session Start ====", maxFileSizeBytes) {}
    ...
    void logMessage (const juce::String& message) override
    {
        ...
        // notify listeners
        listeners.call (&Listener::onWriteToLog, message);
